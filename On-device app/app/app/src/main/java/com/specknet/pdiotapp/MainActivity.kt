...
import com.specknet.pdiotapp.ui.main.SettingsActivity
...
class MainActivity : AppCompatActivity() {
    ...
    lateinit var pastrecordButton:Button
    lateinit var usermannualButton:Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        pastrecordButton = findViewById(R.id.records_button)
        usermannualButton = findViewById(R.id.manual_button)
    ...
    fun setupClickListeners() {
        ...
        usermannualButton.setOnClickListener {
