...
import com.specknet.pdiotapp.databinding.FragmentWeeklyBinding
...
//        StrictMode.setThreadPolicy(policy)
        ...
        val bind = inflater.inflate(R.layout.fragment_weekly, container, false)

        barChart = bind.findViewById(R.id.weekly_barChart)


        val barstats = categoriseThree(getStatsWeek())
...
//        barChart.animateY(3000)
    ...
    fun getStatsWeek(): List<Float> {
        val WeekInMs: Long = 24L * 60L * 60L * 1000L * 7L
        val currentTimestamp = System.currentTimeMillis()
        println("currentTimestamp: "+currentTimestamp)
        val ago = currentTimestamp - WeekInMs
        println("ago week: "+ago.toString())
